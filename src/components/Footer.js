    ...
    <footer className="border-t border-primary/20 bg-primary text-white">
      <div className="max-w-4xl mx-auto px-4 py-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {/* About Column */}
          <div>
            <h3 className="text-lg font-semibold text-neutral  mb-4">Natesh Kumar</h3>
            <p className="text-sm">
              Computer Science student specializing in Cyber Security and Web Development,
              passionate about creating secure and efficient digital solutions.
            </p>
          </div>

          {/* Contact Column */}
          <div>
            <h3 className="text-lg font-semibold text-neutral mb-4">Get in Touch</h3>
          ...
          {/* Social Column */}
          <div>
            <h3 className="text-lg font-semibold text-neutral  mb-4">Connect</h3>
            <div className="flex space-x-4">
              ...
              <a 
                ...
                className="p-2 rounded-full border border-white hover:border-neutral transition-colors"
              >
                <svg className="w-6 h-6 text-primary" fill="white" viewBox="0 0 24 24">
        ...
        <div className="border-t border-white/10 pt-4 text-center text-sm">
          <p>
            © {new Date().getFullYear()} Natesh Kumar. All rights reserved. Built with Next.js and Tailwind CSS
          </p>
        </div>
      </div>
    </footer>
